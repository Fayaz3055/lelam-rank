...
export const emailService = {
  async sendBidConfirmedEmail(params: BidConfirmedEmailParams): Promise<boolean> {
    ...
    const fromEmail = process.env.EMAIL_FROM || 'updates@lelam-rank.vercel.app';
        ...
        body: JSON.stringify({
          ...
          html: `
            <div style="font-family: sans-serif; background: #08090C; color: #F8F9FA; padding: 32px; border-radius: 12px;">
              ...
              <a href="${baseUrl}/${params.entrySlug}" style="display: inline-block; background: #E5C158; color: #000; font-weight: bold; padding: 12px 24px; text-decoration: none; border-radius: 8px;">View Your Spot</a>
        ...
        body: JSON.stringify({
          ...
          html: `
            <div style="font-family: sans-serif; background: #08090C; color: #F8F9FA; padding: 32px; border-radius: 12px;">
              ...
              <a href="${baseUrl}/${params.entrySlug}" style="display: inline-block; background: #E5C158; color: #000; font-weight: bold; padding: 12px 24px; text-decoration: none; border-radius: 8px;">Bid Again to Reclaim Spot</a>
              <p style="margin-top: 24px; font-size: 11px; color: #64748B;">LELAM RANK • Bid. Rank. Rise.</p>
            </div>
          `,
        }),
